...
CREATE OR REPLACE FUNCTION "public"."create_visual_audit_task_with_plan"("p_section_ids" "uuid"[], "p_branch_ids" "uuid"[] DEFAULT NULL::"uuid"[], "p_scheduled_hour" integer DEFAULT 9, "p_deadline_minutes" integer DEFAULT 60, "p_min_photos" integer DEFAULT 1, "p_notes" "text" DEFAULT NULL::"text", "p_recurrence" "text" DEFAULT 'daily'::"text", "p_recurrence_days" integer[] DEFAULT NULL::integer[]) RETURNS json
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    v_tenant_id UUID;
...
ALTER FUNCTION "public"."create_visual_audit_task_with_plan"("p_section_ids" "uuid"[], "p_branch_ids" "uuid"[], "p_scheduled_hour" integer, "p_deadline_minutes" integer, "p_min_photos" integer, "p_notes" "text", "p_recurrence" "text", "p_recurrence_days" integer[]) OWNER TO "postgres";
...
GRANT ALL ON FUNCTION "public"."create_visual_audit_task_with_plan"("p_section_ids" "uuid"[], "p_branch_ids" "uuid"[], "p_scheduled_hour" integer, "p_deadline_minutes" integer, "p_min_photos" integer, "p_notes" "text", "p_recurrence" "text", "p_recurrence_days" integer[]) TO "anon";
GRANT ALL ON FUNCTION "public"."create_visual_audit_task_with_plan"("p_section_ids" "uuid"[], "p_branch_ids" "uuid"[], "p_scheduled_hour" integer, "p_deadline_minutes" integer, "p_min_photos" integer, "p_notes" "text", "p_recurrence" "text", "p_recurrence_days" integer[]) TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_visual_audit_task_with_plan"("p_section_ids" "uuid"[], "p_branch_ids" "uuid"[], "p_scheduled_hour" integer, "p_deadline_minutes" integer, "p_min_photos" integer, "p_notes" "text", "p_recurrence" "text", "p_recurrence_days" integer[]) TO "service_role";
