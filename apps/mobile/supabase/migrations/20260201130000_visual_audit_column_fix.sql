-- ============================================
-- GÖRSEL DENETİM - KOLON DÜZELTMELERI
-- ============================================
-- is_active -> active
...
-- ============================================
-- 1. GÖREV OLUŞTURMA FONKSİYONU (DÜZELTİLMİŞ)
-- ============================================
...
BEGIN
  ...
  -- Şube listesi (active = true kullan, is_active değil)
...
-- ============================================
-- 2. GÖREVLERİ GETİR FONKSİYONU (DÜZELTİLMİŞ)
-- ============================================
