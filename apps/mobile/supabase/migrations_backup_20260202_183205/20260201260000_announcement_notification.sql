...
-- Duyuru yayınlandığında hedef kitleye bildirim gönderir
-- ============================================================================

-- FUNCTION: Duyuru yayınlandığında bildirim gönder
...
BEGIN
  ...
  -- (published_at NULL'dan bir değere geçtiğinde veya INSERT'te published_at varsa)
