-- ================================================================
-- FULL FIX: Tüm RPC Fonksiyonları (Final)
-- ================================================================

-- 1. Email bulma RPC (login için)
...
-- 2. User data RPC (enum-safe, nullable fields)
...
BEGIN
  ...
  SELECT 
    ...
    u.role::TEXT,
    u.tenant_id::TEXT,
    COALESCE(u.branch_id::TEXT, NULL),  -- nullable
    COALESCE(u.region_id::TEXT, NULL),  -- nullable
    COALESCE(u.employee_code::TEXT, NULL)  -- nullable
  FROM public.users u
...
-- 4. User'ı tamamen yeniden oluştur
...
-- ================================================================
-- SONUÇ: Bu SQL'i çalıştır, app'i kapat/aç, login dene
-- FILE001 / test123456
-- ================================================================
